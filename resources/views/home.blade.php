<x-web-layout>
        ...
        <!--hero section start-->
        <section class="hero-section ptb-100" style="background: url({{ asset('web/img/shape/dot-dot-wave-shape.svg') }})no-repeat bottom center">
            <div class="container">
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-xl-5 col-lg-5">
                        <div class="hero-content-wrap text-center text-xl-start text-lg-start" data-aos="fade-right">
                            <h1 class="fw-bold display-6">Facturación inteligente para un control total de tu negocio</h1>
                            <p>Desde la gestión de inventario hasta el seguimiento de ventas y más allá, nuestra solución en la nube está diseñada para
                                ofrecerte todas las herramientas que necesitas para gestionar y expandir tu negocio de manera eficiente y efectiva
                            </p>
                            <div class="hero-subscribe-form-wrap pt-4 position-relative m-auto m-xl-0 d-none d-md-block d-lg-block d-xl-block">
                                <form id="subscribe-form" name="email-form" class="hero-subscribe-form d-block d-lg-flex d-md-flex">
                                    <input type="email" class="form-control me-2" name="Email" data-name="Email" placeholder="Correo Electrónico" id="email-address" required="">
                                    <input type="submit" value="Solicitar Demo" data-wait="Please wait..." class="btn btn-success mt-3 mt-lg-0 mt-md-0">
                                </form>
                                <ul class="nav subscribe-feature-list mt-3">
                                    <li class="nav-item">
                                        <span class="ms-0"><i class="far fa-check-circle text-primary me-2"></i>Demostración Gratuita</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="hero-img-wrap position-relative" data-aos="fade-left">
                            ...
                            <ul class="position-absolute animate-element parallax-element shape-service hide-medium">
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('web/img/creative-agency-2/info_icon_6.svg') }}" alt="shape" class="img-fluid position-absolute color-shape-1">
                                </li>
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('web/img/creative-agency-2/info_icon_2.svg') }}" alt="shape" class="img-fluid position-absolute color-shape-2">
                                </li>
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('web/img/creative-agency-2/info_icon_3.svg') }}" alt="shape" class="img-fluid position-absolute color-shape-3">
                                </li>
                                <li class="layer" data-depth="0.03">
                                    <img src="{{ asset('web/img/creative-agency-2/info_icon_7.svg') }}" alt="shape" class="img-fluid position-absolute color-shape-4">
                                </li>
                            </ul>
                            <!--animated shape end-->
                            <div class="hero-img-wrap position-relative">
                                <div class="hero-screen-wrap">
                                    <div class="phone-screen">
                                        <img src="{{ asset('web/img/screen/phone-screen.png') }}" alt="hero image" class="position-relative img-fluid">
                                    </div>
                                    <div class="mac-screen">
                                        <img src="{{ asset('web/img/screen/mac-screen.png') }}" alt="hero image" class="position-relative img-fluid rounded-custom">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="work-process ptb-100 bg-dark text-white">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-10">
                        <div class="section-heading text-center" data-aos="fade-up">
                            <h2>Herramientas para tu negocio</h2>
                            <p>Con nuestra plataforma en la nube, no solo puedes facturar fácilmente tus ventas,
                                sino que también tienes a tu disposición una amplia gama de herramientas empresariales
                                diseñadas para ayudarte a optimizar tus operaciones y alcanzar tus metas de crecimiento.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="feature-img-holder p-lg-5 pt-3">
                            <div class="p-lg-5 p-3 bg-danger-soft position-relative rounded-custom d-block feature-img-wrap">
                                <div class="position-relative">
                                    <img src="{{ asset('web/img/screen/widget-5.png') }}" class="img-fluid rounded-custom position-relative" alt="feature-image" data-aos="fade-up" data-aos-delay="50" />
                                    <img src="{{ asset('web/img/screen/widget-3.png') }}" class="img-fluid rounded-custom shadow position-absolute bottom--100 right--100 hide-medium" alt="feature-image" data-aos="fade-up" data-aos-delay="100" />
                                </div>
                    ...
                    <div class="col-lg-6 col-12 order-lg-0">
                        <div class="feature-img-holder p-lg-5 pt-3">
                            <div class="bg-primary-soft p-lg-5 p-3 rounded-custom position-relative d-block feature-img-wrap">
                                <div class="position-relative">
                                    <img src="{{ asset('web/img/screen/widget-8.png') }}" class="img-fluid rounded-custom position-relative" alt="feature-image" data-aos="fade-up" data-aos-delay="50" />
                                    <img src="{{ asset('web/img/screen/widget-6.png') }}" class="img-fluid rounded-custom shadow position-absolute top--100 left--100 hide-medium" alt="feature-image" data-aos="fade-up" data-aos-delay="100" />
                                </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="feature-img-holder p-lg-5 pb-3">
                            <div class="bg-danger-soft p-lg-5 p-3 rounded-custom position-relative d-block feature-img-wrap">
                                <div class="position-relative">
                                    <img src="{{ asset('web/img/screen/widget-9.png') }}" class="img-fluid rounded-custom position-relative" alt="feature-image" data-aos="fade-up" data-aos-delay="50" />
                                    <img src="{{ asset('web/img/screen/widget-10.png') }}" class="img-fluid rounded-custom shadow position-absolute top--100 right--100 hide-medium" alt="feature-image" data-aos="fade-up" data-aos-delay="100" />
                                </div>
                                ...
                                <div class="feature-content">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>Modernized
                                            prospecting</li>
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>Clean and
                                            modern</li>
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>Showcasing
                                            success</li>
                                        <li class="py-1"><i class="far fa-check-circle me-2 text-primary"></i>Bootstrap latest
                                            version</li>
                                    </ul>
                                </div>
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="testimonial-tab-content mb-5 mb-lg-0 mb-md-0">
                                            <img src="{{ asset('web/img/testimonial/quotes-left.svg') }}" alt="testimonial quote" width="65" class="img-fluid mb-32">
                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        <div class="author-img-wrap pt-5 ps-5">
                                            <div class="testimonial-video-wrapper position-relative">
                                                <img src="{{ asset('web/img/testimonial/t-1.jpg') }}" class="img-fluid rounded-custom shadow-lg" alt="testimonial author">
                            ...
                            <div class="tab-pane fade" id="testimonial-tab-2" role="tabpanel">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        <div class="author-img-wrap pt-5 ps-5">
                                            <div class="testimonial-video-wrapper position-relative">
                                                <img src="{{ asset('web/img/testimonial/t-2.jpg') }}" class="img-fluid rounded-custom shadow-lg" alt="testimonial author">
                                                <div class="customer-info text-white d-flex align-items-center">
                                                    <a href="http://www.youtube.com/watch?v=hAP2QF--2Dg" class="video-icon popup-youtube text-decoration-none"><i class="fas fa-play"></i> <span class="text-white ms-2 small"> Watch Video</span></a>
                                                </div>
                                                <div class="position-absolute bg-primary-dark z--1 dot-mask dm-size-16 dm-wh-350 top--40 left--40 top-left"></div>
                            ...
                            <div class="tab-pane fade" id="testimonial-tab-3" role="tabpanel">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        <div class="author-img-wrap pt-5 ps-5">
                                            <div class="testimonial-video-wrapper position-relative">
                                                <img src="{{ asset('web/img/testimonial/t-3.jpg') }}" class="img-fluid rounded-custom shadow-lg" alt="testimonial author">
                                                <div class="customer-info text-white d-flex align-items-center">
                                                    <a href="http://www.youtube.com/watch?v=hAP2QF--2Dg" class="video-icon popup-youtube text-decoration-none"><i class="fas fa-play"></i> <span class="text-white ms-2 small"> Watch Video</span></a>
                                                </div>
                                                <div class="position-absolute bg-primary-dark z--1 dot-mask dm-size-16 dm-wh-350 top--40 left--40 top-left"></div>
                            ...
                            <div class="tab-pane fade" id="testimonial-tab-4" role="tabpanel">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        <div class="author-img-wrap pt-5 ps-5">
                                            <div class="testimonial-video-wrapper position-relative">
                                                <img src="{{ asset('web/img/testimonial/t-4.jpg') }}" class="img-fluid rounded-custom shadow-lg" alt="testimonial author">
                                                <div class="customer-info text-white d-flex align-items-center">
                                                    <a href="http://www.youtube.com/watch?v=hAP2QF--2Dg" class="video-icon popup-youtube text-decoration-none"><i class="fas fa-play"></i> <span class="text-white ms-2 small"> Watch Video</span></a>
                                                </div>
                                                <div class="position-absolute bg-primary-dark z--1 dot-mask dm-size-16 dm-wh-350 top--40 left--40 top-left"></div>
                            ...
                            <div class="tab-pane fade" id="testimonial-tab-5" role="tabpanel">
                                <div class="row align-items-center justify-content-between">
                                    ...
                                    <div class="col-lg-5 col-md-6">
                                        <div class="author-img-wrap pt-5 ps-5">
                                            <div class="testimonial-video-wrapper position-relative">
                                                <img src="{{ asset('web/img/testimonial/t-5.jpg') }}" class="img-fluid rounded-custom shadow-lg" alt="testimonial author">
                                                <div class="customer-info text-white d-flex align-items-center">
                                                    <a href="http://www.youtube.com/watch?v=hAP2QF--2Dg" class="video-icon popup-youtube text-decoration-none"><i class="fas fa-play"></i> <span class="text-white ms-2 small"> Watch Video</span></a>
                                                </div>
                                                <div class="position-absolute bg-primary-dark z--1 dot-mask dm-size-16 dm-wh-350 top--40 left--40 top-left"></div>
                        ...
                        <ul class="nav nav-pills testimonial-tab-menu mt-60" id="testimonial" role="tablist" data-aos="fade-up" data-aos-delay="100">
                            <li class="nav-item" role="presentation">
                                <div class="nav-link d-flex align-items-center rounded-custom border border-light border-2 testimonial-tab-link active" data-bs-toggle="pill" data-bs-target="#testimonial-tab-1" role="tab" aria-selected="false">
                                    <div class="testimonial-thumb me-3">
                                        <img src="{{ asset('web/img/testimonial/1.jpg') }}" width="50" class="rounded-circle" alt="testimonial thumb">
                                    </div>
                            ...
                            <li class="nav-item" role="presentation">
                                <div class="nav-link d-flex align-items-center rounded-custom border border-light border-2 testimonial-tab-link" data-bs-toggle="pill" data-bs-target="#testimonial-tab-2" role="tab" aria-selected="false">
                                    <div class="testimonial-thumb me-3">
                                        <img src="{{ asset('web/img/testimonial/2.jpg') }}" width="50" class="rounded-circle" alt="testimonial thumb">
                                    </div>
                                    <div class="author-info">
                                        <h6 class="mb-0">Rupan Oberoi</h6>
                                        <span>Web Designer</span>
                            ...
                            <li class="nav-item" role="presentation">
                                <div class="nav-link d-flex align-items-center rounded-custom border border-light border-2 testimonial-tab-link" data-bs-toggle="pill" data-bs-target="#testimonial-tab-3" role="tab" aria-selected="false">
                                    <div class="testimonial-thumb me-3">
                                        <img src="{{ asset('web/img/testimonial/3.jpg') }}" width="50" class="rounded-circle" alt="testimonial thumb">
                                    </div>
                                    <div class="author-info">
                                        <h6 class="mb-0">Jon Doe</h6>
                                        <span>Software Engineer</span>
                            ...
                            <li class="nav-item" role="presentation">
                                <div class="nav-link d-flex align-items-center rounded-custom border border-light border-2 testimonial-tab-link" data-bs-toggle="pill" data-bs-target="#testimonial-tab-4" role="tab" aria-selected="false">
                                    <div class="testimonial-thumb me-3">
                                        <img src="{{ asset('web/img/testimonial/4.jpg') }}" width="50" class="rounded-circle" alt="testimonial thumb">
                                    </div>
                                    <div class="author-info">
                                        <h6 class="mb-0">Hanry Luice</h6>
                                        <span>App Developer</span>
                            ...
                            <li class="nav-item" role="presentation">
                                <div class="nav-link d-flex align-items-center rounded-custom border border-light border-2 testimonial-tab-link" data-bs-toggle="pill" data-bs-target="#testimonial-tab-5" role="tab" aria-selected="true">
                                    <div class="testimonial-thumb me-3">
                                        <img src="{{ asset('web/img/testimonial/5.jpg') }}" width="50" class="rounded-circle" alt="testimonial thumb">
                                    </div>
                                    <div class="author-info">
                                        <h6 class="mb-0">Ami Nijai</h6>
                                        <span>Customer Support</span>
                ...
                <div class="row justify-content-center mt-100">
                        ...
                        <a href="integration-single.html" class="mb-4 mb-lg-0 mb-xl-0 position-relative text-decoration-none connected-app-single border border-light border-2 rounded-custom d-block overflow-hidden p-5" data-aos="fade-up" data-aos-delay="100">
                            <div class="position-relative connected-app-content">
                                <div class="integration-logo bg-custom-light rounded-circle p-2 d-inline-block">
                                    <img src="{{ asset('web/') }}/img/integations/4.png" width="40" alt="integration" class="img-fluid">
                                </div>
                                <h5>Google Drive</h5>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <a href="integration-single.html" class="position-relative text-decoration-none connected-app-single border border-light border-2 rounded-custom d-block overflow-hidden p-5" data-aos="fade-up" data-aos-delay="150">
                            <div class="position-relative connected-app-content">
                                <div class="integration-logo bg-custom-light rounded-circle p-2 d-inline-block">
                                    <img src="{{ asset('web/img/integations/9.png') }}" width="40" alt="integration" class="img-fluid">
                                </div>
                                <h5>Google Drive</h5>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-article rounded-custom mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="50">
                            <a href="blog-single.html" class="article-img">
                                <img src="{{ asset('web/img/blog/blog-1.jpg') }}" alt="article" class="img-fluid">
                            </a>
                            <div class="article-content p-4">
                                <div class="article-category mb-4 d-block">
                                    <a href="javascript:;" class="d-inline-block text-warning badge bg-warning-soft">Design</a>
                                </div>
                                ...
                                <a href="javascript:;">
                                    <div class="d-flex align-items-center pt-4">
                                        <div class="avatar">
                                            <img src="{{ asset('web/img/testimonial/6.jpg') }}" alt="avatar" width="40" class="img-fluid rounded-circle me-3">
                                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-article rounded-custom mb-4 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
                            <a href="blog-single.html" class="article-img">
                                <img src="{{ asset('web/img/blog/blog-2.jpg') }}" alt="article" class="img-fluid">
                            </a>
                            <div class="article-content p-4">
                                <div class="article-category mb-4 d-block">
                                    <a href="javascript:;" class="d-inline-block text-primary badge bg-primary-soft">Customer</a>
                                </div>
                                <a href="blog-single.html">
                                ...
                                <a href="javascript:;">
                                    <div class="d-flex align-items-center pt-4">
                                        <div class="avatar">
                                            <img src="{{ asset('web/img/testimonial/1.jpg') }}" alt="avatar" width="40" class="img-fluid rounded-circle me-3">
                                        </div>
                                        <div class="avatar-info">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-article rounded-custom mb-0" data-aos="fade-up" data-aos-delay="150">
                            <a href="blog-single.html" class="article-img">
                                <img src="{{ asset('web/img/blog/blog-3.jpg') }}" alt="article" class="img-fluid">
                            </a>
                            <div class="article-content p-4">
                                <div class="article-category mb-4 d-block">
                                    <a href="javascript:;" class="d-inline-block text-danger badge bg-danger-soft">Development</a>
                                </div>
                                <a href="blog-single.html">
                                ...
                                <a href="javascript:;">
                                    <div class="d-flex align-items-center pt-4">
                                        <div class="avatar">
                                            <img src="{{ asset('web/img/testimonial/3.jpg') }}" alt="avatar" width="40" class="img-fluid rounded-circle me-3">
                                        </div>
                                        <div class="avatar-info">
